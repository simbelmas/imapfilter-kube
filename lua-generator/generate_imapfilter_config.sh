...
(
    ...
    jinja2 render "${script_dir}/templates/imapIdleDaemon.lua.j2" "${jinja2_vars_file}" -D "imapfilter_config_dir=${imapfilter_config_dir}" > "${imapfilter_config_dir}/config.lua"
