...
(
    ...
    jinja2 render -D "imapfilter_config_dir=${imapfilter_config_dir}" "${script_dir}/templates/imapIdleDaemon.lua.j2" "${jinja2_vars_file}"  > "${imapfilter_config_dir}/config.lua"
